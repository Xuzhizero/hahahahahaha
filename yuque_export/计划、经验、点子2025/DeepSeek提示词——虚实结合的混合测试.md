---
title: DeepSeek提示词——虚实结合的混合测试
slug: ad8lz7z1q3f1d0ys
url: https://www.yuque.com/caogongzi/pu6995/ad8lz7z1q3f1d0ys
---
...
## <font style="background-color:rgb(255,255,255);">虚实结合的混合测试</font>
<font style="background-color:rgb(255,255,255);">硬件：</font>

<font style="background-color:rgb(255,255,255);">实时仿真机</font>

<font style="background-color:rgb(255,255,255);">双环网交换机用于组网</font>

<font style="background-color:rgb(255,255,255);">辅助系统控制器</font>

<font style="background-color:rgb(255,255,255);">自主航行控制器；</font>

<font style="background-color:rgb(255,255,255);">信息系统控制器；</font>

<font style="background-color:rgb(255,255,255);">能量管理控制器；</font>

<font style="background-color:rgb(255,255,255);">软件部分关键模型（当然不仅于此）：</font>

<font style="background-color:rgb(255,255,255);">·船舶运动模型（航速、航向控制）。</font>

<font style="background-color:rgb(255,255,255);">·综合电力系统模型（发电机调压调速、负载均衡模式、配电保护逻辑）。</font>

<font style="background-color:rgb(255,255,255);">·柴油发电机组模型（调压调速下垂特性、故障注入）。</font>

<font style="background-color:rgb(255,255,255);">·推进电机模型（故障注入）</font>

<font style="background-color:rgb(255,255,255);">·辅助系统模型（燃油泵/阀控制、液位检测逻辑）。</font>

<font style="background-color:rgb(255,255,255);"></font>

结合上面文本,提供核心产品功能中“虚实结合的混合测试”的详细介绍，可以增加一些或细节化一些细节。
